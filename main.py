...
def parse_args():
    ...
    parser.add_argument('--train_nondet', type=str2bool, default=True, help='train det/nondet mode')
    ...
    parser.add_argument('--validate_freq', type=int, default=100, help='The number of image_validate_freq')
