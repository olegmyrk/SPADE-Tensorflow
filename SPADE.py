...
class SPADE(object):
    ...
    def build_model(self):
        ...
        fake_det_x_code_mean, fake_det_x_code_logvar = self.generator_code(tf.stop_gradient(fake_det_x_ctxcode), fake_det_x_supercode, scope="generator_det_code")
        ...
        prior_det_supercode_dist = self.prior_code_dist(tf.stop_gradient(fake_det_x_ctxcode), scope='prior_det_supercode')
        ...
        fake_nondet_x_code_mean, fake_nondet_x_code_logvar = self.generator_code(tf.stop_gradient(fake_nondet_x_ctxcode), fake_nondet_x_supercode, scope="generator_nondet_code")
        ...
        prior_nondet_supercode_dist = self.prior_code_dist(tf.stop_gradient(fake_nondet_x_ctxcode), scope='prior_nondet_supercode')
